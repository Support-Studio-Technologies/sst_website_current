      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative z-10 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            {/* Right Timeline Area */}
            <div className="relative flex flex-col gap-8 pl-4 lg:pl-10">
              {/* Vertical timeline progress bar */}
              <div className="absolute left-[11px] top-[16px] bottom-[16px] w-[10px] rounded-full overflow-hidden bg-neutral-100 z-0">
                <Image
                  src={rectangle26}
                  alt=""
                  fill
