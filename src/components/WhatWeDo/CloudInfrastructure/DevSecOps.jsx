        ...
        <section className="w-full px-6 sm:px-0">
            <div className="relative w-full max-w-screen mx-auto h-[380px] sm:h-[440px] lg:h-[488px] overflow-hidden">
                ...
                <motion.div
                    ...
                    className="relative z-10 h-full flex flex-col justify-center gap-4 sm:gap-6 max-w-[500px] px-6 sm:px-[52px]"
                >
                    <p className="text-black text-2xl sm:text-[32px] font-medium">
                        DevSecOps
                    </p>
                    ...
                    <p className="text-black text-base sm:text-lg font-light">
                        Embed security throughout the software development lifecycle by
                        combining development, operations, and security into a unified
                        delivery process.
                    </p>

                    <p className="text-[#2d8ec5] text-base sm:text-lg font-light">
                        DevSecOps Services
                    </p>
                </motion.div>
            </div>
