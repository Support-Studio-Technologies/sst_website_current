...
export default function HeroText() {
    return (
        <div className="absolute inset-x-0 top-[18%] sm:top-[23%] px-6 sm:px-10 py-6 sm:py-0 md:ml-7 lg:px-[57px]">
            <motion.div
            ...
            >
                ...
                <h1 className="text-white text-2xl sm:text-4xl lg:text-5xl font-medium capitalize mt-6 sm:mt-8 leading-tight">
                    Infrastructure built to carry the weight of enterprise growth.
                </h1>
            </motion.div>
        </div>
    );
