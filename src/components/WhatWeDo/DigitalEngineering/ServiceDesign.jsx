...
const SERVICES = [
    "We engineer enterprise applications with the architecture discipline to handle real transaction volume and change over years, not just the first release cycle",
];

const BENEFITS = [
    "Capacity planning, cost governance, and automation are built into the architecture from the start, so growth does not force a redesign eighteen months later.",
];
            ...
            <div className="flex flex-col lg:flex-row items-end gap-8 lg:gap-8 max-w-[1390px] mx-auto">
                ...
                >
                    <div className="bg-[#f3f1f1] w-full sm:w-[307px] min-h-[331px] p-8 flex flex-col gap-6">
                        <p className="text-black text-2xl font-normal">Applications Built to Last</p>
                    ...
                    <div className="bg-[#f3f1f1] w-full sm:w-[307px] min-h-[331px] p-8 flex flex-col gap-6">
                        <p className="text-black text-2xl font-normal">Modernizing Without Starting Over</p>
                        <ul className="list-disc pl-5 flex flex-col gap-2 text-[#7f7f7f] text-lg font-light">
                            {BENEFITS.map((item) => (
                                <li key={item}>{item}</li>
                            ))}
