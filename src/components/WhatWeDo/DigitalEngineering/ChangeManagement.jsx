...
const STEPS = [
    { title: "Web Development", desc: "Define a clear change strategy that aligns leadership, timelines, and expected outcomes from day one." },
    { title: "Mobile Applications", desc: "Native and cross-platform mobile experiences engineered for enterprise reliability." },
    { title: "API Development", desc: "Deliver the right message to the right audience at the right time throughout the change journey." },
    { title: "Microservices", desc: "Equip teams with the skills and confidence they need to work effectively in the new environment." },
    { title: "DevOps", desc: "Track adoption and sentiment after go-live to reinforce change and address resistance early." },
];
                    ...
                    {STEPS.map((step, index) => {
                        ...
                        return (
                            <div
                                ...
                                className={`relative flex-1 flex flex-col items-center justify-center gap-5 px-4 text-center transition-colors duration-300 ${isHovered ? "bg-[#2d8ec5]/75 cursor-pointer" : "cursor-pointer"
                                    }`}
                            >
