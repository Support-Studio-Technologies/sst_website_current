...
export default function ARVR() {
    ...
    return (
        <section className="w-full py-10 sm:pt-16 sm:pb-0 flex flex-col items-center gap-8 sm:gap-[62px]">
            ...
            >
                <h2 className="text-[#0d0c22] text-2xl font-medium">AR/VR, Blockchain & Quantum Readiness
                </h2>
                        ...
                        {ITEMS.map((item, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`relative flex-1 h-[200px] transition-all duration-300 px-6 py-6 cursor-pointer ${isHovered
                                        ? "bg-[#2D8EC5]/80"
                                        : "bg-white"
                                        }`}
                                >
                                    ...
                                    <h3
                                        className={`font-medium flex items-center justify-center text-left text-xl leading-tight ${isHovered ? "text-white" : "text-black"
                                            }`}
                                    >
                                        {item.title}
                                    </h3>
                                    ...
                                    <AnimatePresence>
                                        {isHovered && (
                                            <motion.p
                                                ...
                                                className="flex mt-4 text-sm leading-6 justify-start items-center text-left text-white"
                                            >
                                                {item.desc}
                                            </motion.p>
                                        )}
